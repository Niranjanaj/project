...
public class Complaintofficial extends Fragment {
    ...
    Button b1;
    String name,area,des,post,returnedstring,user;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        name1 = new ArrayList<NameValuePair>();
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    ...
                    name1.add(new BasicNameValuePair("user",passedstring));
                    http = new HttpPost("http://10.0.2.2/id.php");
                    http.setEntity(new UrlEncodedFormEntity(name1,HTTP.UTF_8));
                    user = httpclient.execute(http,response);
